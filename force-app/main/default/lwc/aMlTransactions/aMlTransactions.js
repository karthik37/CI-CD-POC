...
import getTransactionList from '@salesforce/apex/displayTransactionBoController.displayTransactionBoRecords';
const columns = [{
...
export default class AMlTransactions extends LightningElement {
 @api recordId;
