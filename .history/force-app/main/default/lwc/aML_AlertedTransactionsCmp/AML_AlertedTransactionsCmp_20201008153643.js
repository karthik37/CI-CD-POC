...
transactions;
    ...
    wiredTransactions({error,data}){
        if(data){
            ...
            this.totalTxnCurrencyAmount =  parseFloat("0.0");
            this.totalTxnUSDAmount = parseFloat("0.0");
            ...
            this.transactions.forEach(record => {
                this.totalTxnCurrencyAmount = this.totalTxnCurrencyAmount + parseFloat(record.Transaction_Currency_Amount__c);
                this.totalTxnUSDAmount = this.totalTxnUSDAmount + parseFloat(record.Transaction_USD_Amount__c);
            });
